#define echoPin 12 //Ultrasonik sensörün echo pini
#define trigPin 13 //Ultrasonik sensörün trig pini
#define MotorR1 7
#define MotorR2 6
...
#define MotorL2 4
#define MotorLE 3
long sure, uzaklik; //Süre ve uzaklık diye 2 değişken tanımladık
void setup(){
 // ultrasoniksensör Trig pininnden ses dalgaları gönderdiği için OUTPUT (Çıkış),
 // bu dalgaları Echo pini ile geri aldığı için UNPUT (giriş) olarak tanımlanır.
